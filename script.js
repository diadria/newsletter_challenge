...
const handleSubmit = function(e) {
    ...
    if(emailError) {
      ...
      emailHolder.style.border = "1px solid #ff6257";
      emailHolder.style.color = "#ff6257";
      emailHolder.style.backgroundColor = "#ffcfcc";
...
dismissBtn.addEventListener('click', function() {
  ...
  emailHolder.value = '';
  emailHolder.style.backgroundColor = "#ffffff";
  emailHolder.style.border = "1px solid #949494";
